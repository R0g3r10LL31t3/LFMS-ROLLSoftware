...
@DiscriminatorValue("VariableCost")
...
@XmlRootElement(name = "variableCost")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "variableCost")
public class VariableCost extends Cost implements Serializable {
    ...
    public VariableCost(String uuid) {
        this(0, "VariableCost", uuid,
                null,
                "", "",
