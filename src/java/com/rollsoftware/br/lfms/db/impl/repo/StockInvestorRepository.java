 ...
 */
@RequestScoped
public class StockInvestorRepository
        extends AbstractRepository<StockInvestor, StockInvestor.ObjectDataPK> {

    public StockInvestorRepository() {
        super(StockInvestor.class);
    }
}
