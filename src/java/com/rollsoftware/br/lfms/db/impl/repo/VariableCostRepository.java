 ...
 */
@RequestScoped
public class VariableCostRepository
        extends AbstractRepository<VariableCost, VariableCost.ObjectDataPK> {

    public VariableCostRepository() {
        super(VariableCost.class);
    }
}
