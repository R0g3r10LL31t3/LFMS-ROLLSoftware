...
public class CostService
        extends AbstractServiceFacade<Cost, Cost.ObjectDataPK> {
    ...
    public CostService(CostRepository repo, EntityManager em) {
        this.repo = repo;
        this.em = em;
    }

    @Override
    public Repository<Cost, Cost.ObjectDataPK, String>
            getRepository() {
        return repo;
    }
