...
public class InvestorService
        extends AbstractServiceFacade<Investor, Investor.ObjectDataPK> {
    ...
    public InvestorService(InvestorRepository repo, EntityManager em) {
        this.repo = repo;
        this.em = em;
    }

    @Override
    public Repository<Investor, Investor.ObjectDataPK, String>
            getRepository() {
        return repo;
    }
