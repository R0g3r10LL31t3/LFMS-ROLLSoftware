 ...
 * @date October, 2017
 */
public class StockTreeTest extends ObjectDataTest {
    ...
    private StockTree.ObjectDataPK stockTreePKSaved;
    private StockTreeNode.ObjectDataPK stockTreeNodePKSaved;

    public StockTreeTest() {
    }
    ...
    @Test
    public void testBasicStockTreeInfo() {

        System.out.println("testBasicStockTreeInfo");

        StockTree stockTree = load();

        System.out.println("StockTree: " + stockTree);
        System.out.println("StockTree UUID: " + stockTree.getUUID());
        System.out.println("StockTree ODPK: " + stockTree.getODPK());

        assertEquals(getObjectDataPK(), stockTree.getODPK());
    }

    @Test
    public void testStockTreeToXML() throws JAXBException {

        System.out.println("testStockTreeToXML");

        StockTree stockTree = createObjectData();
        ...
        marshaller.marshal(stockTree, System.out);
        System.out.println();
    }

    @Test
    public void testStockTreeToJSON() throws JAXBException {

        System.out.println("testStockTreeToJSON");
