 ...
 * @author Rogério
 */
public class StockInvestorRepositoryTest extends RepositoryTest {

    private ObjectInterface.ObjectDataInterfacePK entityPK;
    private ObjectInterface entity;

    public StockInvestorRepositoryTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }

    @Override
    public AbstractRepository getNewInstance() {
        return new StockInvestorRepository();
    }
