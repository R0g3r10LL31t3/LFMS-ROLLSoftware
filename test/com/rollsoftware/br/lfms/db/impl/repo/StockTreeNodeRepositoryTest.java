 ...
 * @date October, 2017
 */
public class StockTreeNodeRepositoryTest extends RepositoryTest {
    ...
    public StockTreeNodeRepositoryTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }

    @Override
    public AbstractRepository getNewInstance() {
        return new StockTreeNodeRepository();
    }
