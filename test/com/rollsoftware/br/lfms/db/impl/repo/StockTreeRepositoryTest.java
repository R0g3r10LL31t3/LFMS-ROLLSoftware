 ...
 * @date October, 2017
 */
public class StockTreeRepositoryTest extends RepositoryTest {
    ...
    public StockTreeRepositoryTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }

    @Override
    public AbstractRepository getNewInstance() {
        return new StockTreeRepository();
    }
