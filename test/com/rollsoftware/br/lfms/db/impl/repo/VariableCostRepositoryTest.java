 ...
 * @date October, 2017
 */
public class VariableCostRepositoryTest extends RepositoryTest {

    private ObjectInterface.ObjectDataInterfacePK entityPK;
    private ObjectInterface entity;

    public VariableCostRepositoryTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }

    @Override
    public AbstractRepository getNewInstance() {
        return new VariableCostRepository();
    }
