...
import com.rollsoftware.br.lfms.db.impl.entity.CostFeature;
import com.rollsoftware.br.lfms.db.impl.repo.CostFeatureRepository;
 ...
 * @date October, 2017
 */
public class CostFeatureServiceTest extends ServiceFacadeTest {
    ...
    public CostFeatureServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    public <ODPK extends ObjectInterface.ObjectDataInterfacePK>
        ...
        return (ODPK) new CostFeature.ObjectDataPK("", "");
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new CostFeatureRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new CostFeatureRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    CostFeatureRepository repo, EntityManager em) {
        return (T) new CostFeatureService(repo, em);
    }
