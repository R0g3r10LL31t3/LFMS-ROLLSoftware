...
import com.rollsoftware.br.lfms.db.impl.repo.CostRepository;
 ...
 * @date October, 2017
 */
public class CostServiceTest extends ServiceFacadeTest {
    ...
    public CostServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    public <ODPK extends ObjectInterface.ObjectDataInterfacePK>
        ...
        return (ODPK) new Cost.ObjectDataPK("", "");
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new CostRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new CostRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    CostRepository repo, EntityManager em) {
        return (T) new CostService(repo, em);
    }
