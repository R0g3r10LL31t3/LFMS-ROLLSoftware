 ...
 * @date October, 2017
 */
public class FixedCostServiceTest extends ServiceFacadeTest {
    ...
    public FixedCostServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new FixedCostRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new FixedCostRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    FixedCostRepository repo, EntityManager em) {
        return (T) new FixedCostService(repo, em);
    }
