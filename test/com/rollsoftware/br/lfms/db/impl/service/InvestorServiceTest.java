...
import com.rollsoftware.br.lfms.db.impl.repo.InvestorRepository;
 ...
 * @date October, 2017
 */
public class InvestorServiceTest extends ServiceFacadeTest {
    ...
    public InvestorServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new InvestorRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new InvestorRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    InvestorRepository repo, EntityManager em) {
        return (T) new InvestorService(repo, em);
    }
