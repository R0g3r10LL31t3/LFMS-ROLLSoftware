...
import com.rollsoftware.br.lfms.db.impl.repo.StockInfoRepository;
 ...
 * @date October, 2017
 */
public class StockInfoServiceTest extends ServiceFacadeTest {
    ...
    public StockInfoServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new StockInfoRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new StockInfoRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    StockInfoRepository repo, EntityManager em) {
        return (T) new StockInfoService(repo, em);
    }
