...
import com.rollsoftware.br.lfms.db.impl.repo.StockInvestorRepository;
 ...
 * @date October, 2017
 */
public class StockInvestorServiceTest extends ServiceFacadeTest {
    ...
    public StockInvestorServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    public <ODPK extends ObjectInterface.ObjectDataInterfacePK>
        ...
        return (ODPK) new StockInvestor.ObjectDataPK("", "");
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new StockInvestorRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new StockInvestorRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    StockInvestorRepository repo, EntityManager em) {
        return (T) new StockInvestorService(repo, em);
    }
