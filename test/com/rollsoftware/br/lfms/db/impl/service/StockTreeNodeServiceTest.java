 ...
 * @date October, 2017
 */
public class StockTreeNodeServiceTest extends ServiceFacadeTest {
    ...
    public StockTreeNodeServiceTest(EntityManagerInterface emInterface) {
        super(emInterface);
    }
    ...
    public <ODPK extends ObjectInterface.ObjectDataInterfacePK>
        ...
        return (ODPK) new StockTreeNode.ObjectDataPK("", "");
    }
    ...
    protected <T extends ServiceFacade>
        ...
        return createServiceFacade(
                new StockTreeNodeRepository(), getEntityManager());
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(EntityManager em) {
        return createServiceFacade(
                new StockTreeNodeRepository(), em);
    }

    protected <T extends ServiceFacade>
            T createServiceFacade(
                    StockTreeNodeRepository repo, EntityManager em) {
        return (T) new StockTreeNodeService(repo, em);
    }
    ...
    /**
     * StockTreeNode.uuid use same StockInfo.uuid, then create a duplicate on
     * reinsertion
     *
